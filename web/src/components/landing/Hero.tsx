...
import { Layers, Percent, Users, ChevronDown } from 'lucide-react';
        ...
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
                ...
                <p className="text-lg text-white/80 max-w-2xl mx-auto leading-relaxed mb-8">
                    Order directly from farmers you can trust. We aggregate orders in batches
                    for Mango, Rice, Jaggery, Tur Dal, Jowar, and more.
                    Know your source. Pay fair prices.
                </p>
