                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    ...
                    <div className="order-2 lg:order-1">
                        ...
                        <p className="text-xl text-mandi-muted leading-relaxed mb-10 font-light text-balance">
                            We don't sell anonymous produce. Every batch is an open book—linked to a specific family,
                            village, and harvest date. You're not just buying food; you're acknowledging a relationship.
                        </p>
                        ...
                        <div className="relative bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden transform rotate-2 hover:rotate-0 transition-all duration-700 ease-out group">
                            ...
                            <div className="bg-mandi-green px-6 py-4 flex justify-between items-center text-white">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs font-bold tracking-wider opacity-90">BATCH #2026-M1</span>
                                </div>
                            ...
                            <div className="p-8">
                                <div className="flex justify-between items-start mb-8">
                                    <div>
                                        <h3 className="text-3xl font-serif font-bold text-mandi-dark mb-1">Alphonso Mangoes</h3>
                                        <p className="text-mandi-muted text-sm">Premium Grade A • Organic Practice</p>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-xs text-mandi-muted uppercase tracking-wide mb-1">Price / Dozen</p>
