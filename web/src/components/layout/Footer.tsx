...
import { Mail, Wheat, MessageCircle } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed mb-6">
                            Batch-based aggregation for grains, spices, and seasonal fruits. Connecting farmers directly with buyers.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-gray-400">
                            <li>
                                <Link to="/" className="hover:text-white focus:text-white focus:outline-none focus-visible:underline">
                                    Home
                                </Link>
                            </li>
                            <li>
                                <a href="/#our-story" className="hover:text-white focus:text-white focus:outline-none focus-visible:underline">
                                    Our Story
                                </a>
                            </li>
                            <li>
                                <a href="/#how-it-works" className="hover:text-white focus:text-white focus:outline-none focus-visible:underline">
                                    How it Works
                                </a>
                            </li>
                            <li>
                                <Link to="/rules" className="hover:text-white focus:text-white focus:outline-none focus-visible:underline">
                                    Rules
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-gray-400">
                            <li>
                                <a href="#" className="hover:text-white focus:text-white focus:outline-none focus-visible:underline">
                                    Terms of Service
                                </a>
                            </li>
                            <li>
