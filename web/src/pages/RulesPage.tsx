...
const batchStates = [
  {
    ...
    description: 'Admin prepares the batch, sets pricing and products.',
  },
      ...
      <main className="pt-20">
        ...
        <section className="py-16 border-b border-gray-100">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-mandi-muted mb-8">
              Payments are split into two stages to ensure commitment from buyers and fair
            ...
            <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-yellow-800 text-sm">
                <strong>Note:</strong> All payments are manual UPI transfers. We do not auto-settle
                or process automated refunds.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <p className="text-mandi-muted text-sm">
                <strong>Important:</strong> Fulfilment type cannot be changed after the batch
                cutoff. Choose carefully when placing your order.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4 text-mandi-muted">
              <p>
                Every product on Apna Khet is linked to a specific farmer. We share their name,
                location, and story with you.
              </p>
              <p>
                To maintain operational efficiency and prevent miscommunication, we do not
                facilitate direct buyer-farmer communication. All coordination happens through Apna
                Khet.
              </p>
              <p>
