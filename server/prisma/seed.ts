...
async function main() {
    ...
    console.log(`✅ Hubs: ${hubs.length} created`);
    ...
    console.log(`✅ BatchProducts: ${batchProducts.length} created`);
    ...
    console.log(`✅ Orders: 2 created with items and payments`);
    ...
    console.log(`✅ EventLog: 4 entries created`);
    ...
    console.log(`   Users:         1 Admin + ${buyers.length} Buyers`);
    console.log(`   Hubs:          ${hubs.length}`);
    console.log(`   Farmers:       ${farmers.length}`);
    console.log(`   Products:      ${products.length}`);
    console.log(`   Batches:       ${batches.length} (DRAFT, OPEN, CLOSED, COLLECTED, SETTLED)`);
    console.log(`   BatchProducts: ${batchProducts.length}`);
    console.log(`   Orders:        2 (with items & payments)`);
    console.log('─'.repeat(40));
